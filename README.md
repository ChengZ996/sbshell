...
## 一键脚本：
```
bash <(curl -sL https://git.liunasc.xyz/https://github.com/ChengZ996/sbshell/blob/master/sbshall.sh)
```
（初始化运行结束，输入“**sb**”进入菜单）
...
### 测试版：  
tproxy：
https://git.liunasc.xyz/https://github.com/ChengZ996/sbshell/blob/master/config_template/config_tproxy_dev.json    
tun：
https://git.liunasc.xyz/https://github.com/ChengZ996/sbshell/blob/master/config_template/config_tun_dev.json  

### 稳定版：  
tproxy：
https://git.liunasc.xyz/https://github.com/ChengZ996/sbshell/blob/master/config_template/config_tproxy.json    
tun：
https://git.liunasc.xyz/https://github.com/ChengZ996/sbshell/blob/master/config_template/config_tun.json  
